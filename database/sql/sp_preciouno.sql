...
INSERT INTO
    users (name, email, password, idrol)
values
    (spname, spemail, sppassword, spidrol);
...
set
    message = "Usuario Registrado Correctente";
...
INSERT INTO
    vehiculos (placa, placasecundaria, estado)
values
    (spplaca, spplacasecundaria, "Activo");

if Row_count () > 0 then
SET
    idvehiculo = LAST_INSERT_ID ();

set
    success = 1;

set
    message = "Vehiculo Registrado Correctente";
...
set
    message = "NO SE REGISTRO EL VEHICULO";
...
if Row_count () > 0 then
SET
    idtransportista = LAST_INSERT_ID ();

set
    success = 1;

set
    message = "Transporte Registrado Correctente";
...
set
    message = "NO SE REGISTRO EL TRANSPORTE";
...
INSERT INTO
    conductores (nombre, dni, estado, idtransportista, idvehiculo)
values
    (
        spnombre,
        spdni,
...
set
    message = "NO SE REGISTRO EL CONDUCTOR";
...
set
    message = "NO SE REGISTRO LA GUIA DE REMISION";
...
insert into
    detalleguia (idguia, idproducto, condicion, cantrecibida)
values
    (spidguia, spidproducto, spcondicion, spcant);

if Row_count () > 0 then
SET
    iddetalleguia = LAST_INSERT_ID ();

set
    success = 1;

set
    message = "detalleguia Registrado Correctente";
...
set
    message = "NO SE REGISTRO EL detalleguia";
...
if Row_count () > 0 then
SET
    idvalidacionguia = LAST_INSERT_ID ();
...
set
    message = "validacion Registrado correctamente";
...
set
    message = "NO SE REGISTRO la validacion, matate.";
