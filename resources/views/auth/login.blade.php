...
<body class="bg-light">
    <div class="login-container">
        ...
        <div class="right-side">
            <img src="{{ asset('storage/img/Hiperbodega_Precio_Uno.svg') }}" alt="Hiperbodega Precio Uno"
                class="logo-img" alt="Hiperbodega Precio Uno" style="width: 280px; height: auto;">
        </div>
    </div>
</body>
