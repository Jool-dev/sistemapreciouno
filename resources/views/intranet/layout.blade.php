...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html">CONTROL LOGISTICO</a>
        <!-- Sidebar Toggle-->
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    {{--  <li><a class="dropdown-item" href="{{route('vistaprofile')}}">Perfil</a></li>  --}}
                    <li><hr class="dropdown-divider" /></li>
                        <!-- ASI SE LLAMA UNA RUTA -->
                    <li><a class="dropdown-item" href="{{route('vistalogin')}}">Cerrar Sesion</a></li>
                </ul>
            </li>
        </ul>
    </nav>
