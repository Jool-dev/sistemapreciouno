...
<body
    ...
    <footer class="py-5 text-center text-sm text-black dark:text-white/70">
        ...
        <p class="font-semibold">
            <a href="{{ route('vistalogin') }}"
                class="text-gray-950 underline decoration-sky-400 underline-offset-3 hover:decoration-2 dark:text-white">Intranet
                de SistemaPrecioUno &rarr;</a>
        </p>
    </footer>
